...
from uniflowmatch.utils.parallel import parallel_threads
from uniflowmatch.datasets.utils import cropping  # noqa


def get_parser():
    import argparse
    parser = argparse.ArgumentParser()
    parser.add_argument('--megadepth_dir', '-m', required=True)
    parser.add_argument('--precomputed_pairs', '-p', required=True)
    parser.add_argument('--output_dir', '-o', default='data/megadepth_processed')
    return parser
